...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		// add value to degree sequence list
		for(int vIndex = 0; vIndex < numVertices; vIndex++)
		{
			dS.add(this.getNeighbors(vIndex).size() + this.getInNeighbors(vIndex).size());
		}
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/myhood.map", "data/intersections/myhood.intersections");
		...
		GraphLoader.loadRoadMap("data/maps/myhood.map", graphFromFile);
