...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 // define two hops list to return
		 List<Integer> twoHopsDistances = new ArrayList<Integer>();
		 // define one hop list
		 List<Integer> oneHopDistances = new ArrayList<Integer>(this.getNeighbors(v));
		 
		 // search reachable vertices from one hop listed nodes
		 for(Integer vIndex : oneHopDistances)
		 {
			 twoHopsDistances.addAll(this.getNeighbors(vIndex));
		 }
