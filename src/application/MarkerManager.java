...
public class MarkerManager {
    ...
    protected static String markerIncidentURL = "http://maps.google.com/mapfiles/kml/shapes/caution.png";
...
//        destinationMarker.setZIndex(STRTDEST_Z);
    ...
    public static MarkerOptions createDefaultIncident(LatLong coord) {
    	MarkerOptions markerOptions = new MarkerOptions();
    	markerOptions.animation(null)
    				 .icon(markerIncidentURL)
    				 .position(coord)
                     .title(null)
                     .visible(true);
    	return markerOptions;
